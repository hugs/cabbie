...
Browser.prototype.setWindowSize = function (width, height) {
  return this._requestJSON('POST', '/window/current/size', {
    width: width,
    height: height
  });
};
...
Browser.prototype.setWindowPosition = function (x, y) {
  return this._requestJSON('POST', '/window/current/position', {
    x: x,
    y: y
  });
};
 ...
 */
Browser.prototype.setWindowMaximize = function () {
  return this._requestJSON('POST', '/window/current/maximize');
};
...
/**
 * Wait for the expression to be true.
 *
 * Expression should be a stringified JavaScript expression.
 * You'll probably want to add 'return ' at the beginning of the
 * expression.
 *
 * @param {String} expression
 * @param {Number} timeout
 */
Browser.prototype.waitFor = function(expression, timeout) {
 ...
 */
Browser.prototype.getScreenshot = function() {
  return this._requestJSON('GET', '/screenshot');
}
